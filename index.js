...
app.post('/enviar-ticket-pdf', authMiddleware, async (req, res) => {
    const { numero, datos_ticket, foto_evidencia, mensaje } = req.body; // <--- LEEMOS EL MENSAJE AQUI
    ...
    try {
        ...
        // USAMOS EL MENSAJE DINAMICO DEL BODY
        const captionFinal = mensaje || "Su pedido ha sido entregado. Adjunto encontrará su ticket y evidencia de entrega. 📄🏠";
